...
var _incrementalDom = __webpack_require__(1);
...
(0, _khufuRuntime.attach)(document.getElementById('app'), (0, _errors.main)(), {
...
var _SPAN_ATTRS = ["color", "red"];
function main() {
  return function main$(key) {
    var _div_stores = (0, _khufuRuntime.elementOpen)("div", key + "-1-div", null, "__stores", {
      fruits: function fruits() {
        return [_store.Fruits, []];
      },
    ...
    (0, _khufuRuntime.elementOpen)("p", "-1-p");
    {
      var _has_error_state = _div_stores.has_error.getState();

      (0, _khufuRuntime.elementOpen)("label", "-1-label");
      (0, _khufuRuntime.text)("Banana price is: ");
      (0, _khufuRuntime.elementClose)("label");

      if (!_has_error_state) {
        try {
          (0, _khufuRuntime.elementOpen)("b", "-2if0-1catch-1-b");
          {
            var _fruits_state = _div_stores.fruits.getState();

            (0, _khufuRuntime.text)(_fruits_state.banana.price);
          }
          (0, _khufuRuntime.elementClose)("b");
        } catch (_error) {
          if (!(_error instanceof _khufuRuntime.SuppressedError)) {
            _div_stores.has_error.dispatch((0, _store.set_true)());

            throw new _khufuRuntime.SuppressedError(_error);
          }
        ...
        var _ln_click = function _ln_click(event) {
          _div_stores.has_error.dispatch((0, _store.set_false)());
        };

        (0, _khufuRuntime.elementOpen)("span", "-2els-1-span", null, "style", {
          backgroundColor: "red",
          color: "white",
          padding: "8px",
        ...
        (0, _khufuRuntime.elementOpen)("span", "-1-span", _SPAN_ATTRS);
        (0, _khufuRuntime.text)("Can't calculate ");
        (0, _khufuRuntime.elementClose)("span");

        (0, _khufuRuntime.elementOpen)("button", "-2-button", null, "onclick", _ln_click);
        (0, _khufuRuntime.text)("Retry");
        (0, _khufuRuntime.elementClose)("button");
        (0, _khufuRuntime.elementClose)("span");
      }
    }
    (0, _khufuRuntime.elementClose)("p");
    (0, _khufuRuntime.elementOpen)("p", "-2-p");

    function _ln_click2(event) {
      _div_stores.fruits.dispatch((0, _store.good_value)());
    }

    (0, _khufuRuntime.elementOpen)("button", "-1-button", null, "onclick", _ln_click2);
    (0, _khufuRuntime.text)("Set good value");
    (0, _khufuRuntime.elementClose)("button");
    (0, _khufuRuntime.text)(" ");

    function _ln_click3(event) {
      _div_stores.fruits.dispatch((0, _store.bad_value)());
    }

    (0, _khufuRuntime.elementOpen)("button", "-3-button", null, "onclick", _ln_click3);
    (0, _khufuRuntime.text)("Set bad value");
    (0, _khufuRuntime.elementClose)("button");
    (0, _khufuRuntime.text)(" ");

    function _ln_click4(event) {
      _div_stores.fruits.dispatch((0, _store.good_value)());

      _div_stores.has_error.dispatch((0, _store.set_false)());
    }

    (0, _khufuRuntime.elementOpen)("button", "-5-button", null, "onclick", _ln_click4);
    (0, _khufuRuntime.text)("Set good value and retry");
    (0, _khufuRuntime.elementClose)("button");
    (0, _khufuRuntime.text)(" ");

    function _ln_click5(event) {
      _div_stores.fruits.dispatch((0, _store.bad_value)());

      _div_stores.has_error.dispatch((0, _store.set_false)());
    }

    (0, _khufuRuntime.elementOpen)("button", "-7-button", null, "onclick", _ln_click5);
    (0, _khufuRuntime.text)("Set bad value and retry");
    (0, _khufuRuntime.elementClose)("button");
    (0, _khufuRuntime.elementClose)("p");
...
exports.good_value = good_value;
exports.bad_value = bad_value;
function Flag() {
...
function Fruits() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { "banana": { "price": 17 } };
    var action = arguments[1];
