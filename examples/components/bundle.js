...
(0, _khufuRuntime.attach)(document.getElementById('app'), (0, _components.main)(), {
...
var _DIV_ATTRS = ["class", "b-components label"],
    _DIV_ATTRS2 = ["class", "b-components badge"];


var _style_remover = (0, _khufuRuntime.add_style)(".b-components.badge {\n    display: inline-block;\n    margin-left: 8px;\n    background-color: gray;\n    border-radius: 4px;\n    padding: 1px 6px 1px 6px;\n    color: white\n}\n.b-components.label {\n    line-height: 25px\n}");
...
function label() {
  return function label$(key, _ref) {
    var body = _ref.body,
        badge = _ref.badge;

    (0, _khufuRuntime.elementOpen)("div", key + "-1-div", _DIV_ATTRS);
    (0, _khufuRuntime.item)(body(), "-1");

    if (badge) {
      (0, _khufuRuntime.elementOpen)("div", "-2if0-1-div", _DIV_ATTRS2);
      (0, _khufuRuntime.item)(badge(), "-1");
...
function main() {
  return function main$(key) {
    label()(key + "-1", {
      body: function body() {
        return function (key) {
          (0, _khufuRuntime.text)("Inbox");
        };
      },
      badge: function badge() {
        return function (key) {
          (0, _khufuRuntime.text)(10);
        };
      }
    });
    label()(key + "-2", {
      body: function body() {
        return function (key) {
          (0, _khufuRuntime.text)("Sent mails");
        };
      }
    });
  };
