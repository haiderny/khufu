...
(0, _khufuRuntime.attach)(document.getElementById('app'), (0, _counter.main)(), {
  ...
  return function main$(key) {
...

    {
      var _ln_click = function _ln_click(event) {
        _p_stores.cnt.dispatch((0, _counter.counter)(1));
      };
      ...
      var _cnt_state = _p_stores.cnt.getState();
      ...
      (0, _khufuRuntime.elementVoid)("input", "-2-input", _INPUT_ATTRS, "value", _cnt_state);
